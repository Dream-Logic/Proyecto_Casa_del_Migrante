...
@section('contenido')
    ...
    box-shadow: 0px 5px 3px 3px rgba(194,194,194,1);">
            ...
            <form method="post" action="{{route('narracion.update',["id"=>$narracion->id])}}"enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="col-md-12 justify-content-center">
                    ...
                    <textarea class="form-control" id="vulneracion" name="vulneracion"
                              ...
                              maxlength="50"
                              >value="{{$narracion->vulneracion}}"</textarea>
                </span></div>
        ...
        <textarea class="form-control" id="protección" name="proteccion"
                  ...
                  rows="3">{{$narracion->proteccion}}</textarea><br>
                        </span></div>
                <br>
