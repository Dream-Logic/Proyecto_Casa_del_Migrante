    ...
    <section class="container">
        ...
        <div class="" style="-moz-box-shadow: 0px 5px 3px 3px rgb(194,194,194);
            ...
            <div class="card-header" style="background-color: #4cd213">
                <label class="card-title" style="color: black;">Datos Personales de la Madre y/o Resposable
                    Legal</label>
            </div>
            ...
            <form method="Post" action="{{route('responsable.store',['id'=>$id])}}">
                    ...
                    <div class="col-md-5 justify-content-center">
                        ...
                        <select class="form-control" name="parentesco">
                            ...
                            <option value="responsable"
                                    @if(old('parentesco') === "responsable") selected='selected' @endif>
                                Responsable Legal
                            </option>
                        </select>
                        <br></div>
                ...
                <div class="trans text-center">
                    ...
                    <a class="btn btn-outline-danger justify-content-center"
                       href="{{route('narracion.nuevo', ['id'=>$id])}}">Siguiente</a>
